import tugas1.TicketInfo;

class TaxiTicket extends tugas1.Ticket implements tugas1.Operational {
    ...
    public void displayInfo() {
        System.out.println("Passenger Name : " + pasenggerName);
        System.out.println("Start Location : " + startLocation);
        System.out.println("Destination : " + destination);
        System.out.println("Price : " + price);
        System.out.println("Final Price : " + CalculatedFinalPrice()); // Price including 10% tax
    }
